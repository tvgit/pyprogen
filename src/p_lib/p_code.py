...
def p_main():
    ...
    parts = []
    parts.append(y_main_02)
    parts.append(y_main_04)
    parts.append(y_main_96)
    parts.append(y_main_98)

    for part in parts:
        part = part.replace("xx_main", p_glbls.prog_name[:-3])
        part = part.replace("xx_CAParser", p_glbls.CAParser_fn[:-3])
        part = part.replace("xx_parser", p_glbls.CAParser_func)
        part = part.replace("xx_main", p_glbls.prog_name[:-3])
