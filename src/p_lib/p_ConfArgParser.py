...
def p_ConfArgParser(conf_file_fn='./pyprogen.conf'):
    ...
    #first_line = '# 1 generated by: >p_ConfArgParser.py< (' + now_str + ')\n'
    #patterns.CA_Parser[02] = first_line + patterns.CA_Parser[02]
    #last_line = '# 2 ' + now_str + '\n'
    #patterns.CA_Parser[98] = patterns.CA_Parser[98] + last_line
